...
<template>
  <el-main>
    <el-alert title="select深度改造的表格选择器, 非常适用于大量数据选择的场景" type="success"
    ...
    <el-card shadow="never" header="多选">
      <sc-table-select v-model="value" :apiObj="apiObj" :table-width="700" multiple clearable collapse-tags
                       collapse-tags-tooltip :props="props" @change="change">
          ...
          <el-form :inline="true" :model="form">
            ...
            <el-form-item>
              <el-date-picker v-model="form.date" value-format="YYYY-MM-DD" type="date"
                              placeholder="注册时间" :teleported="false"></el-date-picker>
            </el-form-item>
            <el-form-item>
