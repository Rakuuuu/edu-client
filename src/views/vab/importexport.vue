    ...
    <el-row :gutter="15">
      <el-col :lg="12">
        <el-card shadow="never" header="导入(使用mock,有50%几率导入失败)">
          ...
          <sc-file-import :apiObj="$API.common.importFile" :data="{otherData:'demo'}"
                          templateUrl="http://www.scuiadmin/file.xlsx" accept=".xls, .xlsx" :maxSize="30"
      ...
      <el-col :lg="12">
        <el-card shadow="never" header="导出">
          ...
          <sc-file-export :apiObj="$API.common.exportFile" blob fileName="人员列表" :data="{otherData:'demo'}"
                          showData :column="column" :fileTypes="['xlsx','docx','pdf']">
            <template #default="{open}">
          ...
          <el-descriptions :column="1" border size="small" style="margin-top: 15px;">
            <el-descriptions-item label="apiObj" :width="200">Object
