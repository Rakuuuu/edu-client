<template>
      ...
      <el-card shadow="never">
        <el-tabs tab-position="top">
          ...
          <el-tab-pane label="API路径配置">
            <el-alert title="$API 映射文件: @/api/index.js 统一接口管理器, 所以需提前配置好API对象."
                      type="warning" style="margin:0 0 20px 0;"></el-alert>
            <el-row>
              <el-col :xl="12" :lg="8">
  ...
  <el-dialog title="代码预览" v-model="codeVisible" width="60%" append-to-body destroy-on-close>
    <el-alert title="需将VUE文件放置views文件夹,路由匹配组件的路径下,如文件名为index.vue可不需要写文件名"
              type="success" show-icon style="margin-bottom: 20px;"></el-alert>
