                ...
                <div class="sc-filter-main">
                  ...
                  <table v-else>
                    ...
                    <tr v-for="(item,index) in filter" :key="index">
                      ...
                      <td>
                        <py-select v-model="item.field" :options="fields" :filter="filter"
                                   placeholder="过滤字段" filterable
                      ...
                      <td>
                        <el-input v-if="!item.field.type" v-model="item.value"
                                  placeholder="请选择过滤字段" disabled></el-input>
                        <!-- 输入框 -->
                        ...
                        <el-date-picker v-if="item.field.type=='datetimerange'"
                                        v-model="item.value" type="datetimerange"
                  ...
                  <el-button type="primary" text icon="el-icon-plus" @click="addFilter">增加过滤项
                  </el-button>
                </div>
              </el-scrollbar>
            </el-tab-pane>
